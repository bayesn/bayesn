...
class SEDmodel(object):
    ...
    def initial_guess(self, args, reference_model='M20_model'):
        ...
        if args['mode'] == 'training_v2':
            ...
            param_init['W0_red'] = jnp.array([-3.2120889e-01, -1.6583735e-01, -1.5471174e-01, -9.3466029e-02,
                                              -5.8891880e-03, 1.5662189e+00, -2.1205887e-01, -3.4002032e-02,
                                              6.2050637e-02, 1.1560084e-01, 8.1009871e-01, -8.2401924e-02,
                                              5.3405955e-02, 4.1145183e-02, 7.5028740e-02, 7.1096182e-02,
                                              -5.4492307e-04, 7.6860331e-02, 8.6805500e-02, 1.2272103e-02,
                                              1.5465278e-02, 1.7583300e-01, 3.5494640e-01, -6.8453038e-01,
                                              1.7681934e-01, 5.5282790e-02, 1.8119450e-01, 2.2544539e-01,
                                              5.3017646e-01, -5.5841636e-02, -8.4200893e-03, -4.7995124e-02,
                                              4.7149170e-02, 1.4160931e-01, 4.6781946e-02])
            param_init['W1_red'] = jnp.array([-0.2684355, -2.153108, -1.2360117, -1.4375595, -0.94639206,
                                              -0.01736179, -1.5502435, -0.55664223, -0.7359096, -0.14269961,
                                              -0.80853105, -0.39087296, -0.16570823, -0.72015154, -0.7183314,
                                              -0.4391036, 0.20915645, -0.1977812, -2.226724, -0.57976794,
                                              0.2040822, -0.31959352, -1.6557553, -1.151641, -2.1818628,
                                              -2.1820219, -1.8328527, -1.741137, -1.4578267, -0.09122137,
                                              -1.1992627, -1.2407359, -1.5242057, -2.4176643, -0.4378088])
            # param_init['Wc_red'] = jnp.array([0.33417338, 2.3524976, 1.5183244, 1.7990184, 0.94003797,
            #                                   0.09279568, -2.4245248, 1.2781079, 0.36919928, 0.57796633,
            #                                   1.1207025, 1.5758365, 0.8216449, 0.8098405, 0.5766594,
            #                                   -0.1501375, 0.1344218, 1.9843255, 0.4753735, -0.10419659,
            #                                   0.2908966, 1.5682667, 0.8464299, 2.0843961, 1.8866293,
            #                                   1.5701152, 1.4952501, 1.2820684, 0.16232008, 1.194096,
            #                                   1.1703538, 1.4807429, 2.2081795, 0.2765803])
