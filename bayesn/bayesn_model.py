...
class SEDmodel(object):
    ...
    def train_model_popRV_nocosmo(self, obs, weights):
        """
        Numpyro model used for training to learn global parameters with a truncated Gaussian RV distribution
    ...
    def run(self, args, cmd_args):
        ...
        if args['mode'].lower() == 'training_globalrv':
            ...
            nuts_kernel = NUTS(self.train_model_popRV, adapt_step_size=True, target_accept_prob=0.8,
                               ...
                               dense_mass=False, find_heuristic_step_size=False, regularize_mass_matrix=False,
                               step_size=0.1)
        elif args['mode'].lower() == 'training_poprv_nocosmo':
            nuts_kernel = NUTS(self.train_model_popRV_nocosmo, adapt_step_size=True, target_accept_prob=0.8,
                               init_strategy=init_strategy,
                               dense_mass=False, find_heuristic_step_size=False, regularize_mass_matrix=False,
                               step_size=0.1)
    ...
    def process_dataset(self, args):
        ...
        if 'version_photometry' in args.keys():  # If using all files in directory
            ...
            refined_drop_list = ['1283923', '1519038', '1773339', '1247420', '1259412', '1309874', '1314897',
                                 '1246430', '1250432', '1250785', '1251028', '1259544', '1265143', '1277892', '1283289', '1291639',
                                 '1291799', '1292084', '1292834', '1294158', '1323331', '1276528', '1292805',
                                 '1446086']
            mass_drop_list = ['1692023', '1335694', '1876378', '1266657', '1333438', '1915237', '1934160', '1290779', '1303004', '1296273']
            ...
            drop_list = mass_drop_list + SALT_quality_drop_list + other_quality_drop_list
            tdiffs = []
            sne, peak_mjds = [], []
            # For FITRES table
