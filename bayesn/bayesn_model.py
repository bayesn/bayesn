...
class SEDmodel(object):
    ...
    def initial_guess(self, args, reference_model='M20_model'):
        ...
        if args['mode'] == 'training_v2':
            ...
            param_init['W0_red'] = jnp.array([-0.296743, -0.17788744, -0.15784223, -0.09738222, -0.01873794,
                                              1.4291767, -0.28803506, -0.04351072, 0.05767323, 0.10712488,
                                              0.8190704, 0.01286844, 0.02489451, 0.04537648, 0.06404073,
                                              0.06324839, -0.08529011, 0.07391883, 0.07742025, 0.00813637,
                                              0.00691619, 0.16895677, 0.35623473, -0.6261852, 0.15733027,
                                              0.05702822, 0.17194188, 0.21918152, 0.50593126, -0.11662934,
                                              -0.00676124, -0.05773953, 0.03951922, 0.13737708, 0.2146262])
            param_init['W1_red'] = jnp.array([-2.2637852e-01, -2.2241392e+00, -1.1032957e+00, -1.3756945e+00,
                                              -8.2874161e-01, -7.5390365e-04, -1.2946199e+00, -6.1891478e-01,
                                              -7.2860265e-01, -1.6757023e-01, -7.9040730e-01, -3.6155200e-01,
                                              -5.6042969e-01, -7.7168387e-01, -7.6634610e-01, -4.8431146e-01,
                                              1.0271117e-01, -1.8882462e-01, -2.1926925e+00, -6.8182951e-01,
                                              1.6092557e-01, -3.4302798e-01, -1.3974376e+00, -1.2801874e+00,
                                              -2.1153805e+00, -2.1600664e+00, -1.8223187e+00, -1.6794858e+00,
                                              -1.3856523e+00, -2.1865989e-01, -1.0640701e+00, -1.2593508e+00,
                                              -1.3956366e+00, -2.3517530e+00, -4.2700967e-01])
            param_init['Wc_red'] = jnp.array([0.0886981, 1.6736284, 1.9176013, 2.3302696, 1.3670901,
                                              0.02600376, -0.05050712, 0.9741461, 0.06905823, 0.08847135,
                                              -0.30330607, -0.7918966, -0.18197271, 0.03318184, -0.18089491,
                                              0.19904873, 0.47277927, 1.1255909, -0.78216106, -1.0616077,
                                              -0.5485744, 0.8464212, 0.01274969, 1.5039138, 0.32225677,
                                              -0.08628955, -0.12947589, 0.40614623, 0.03792764, 0.74624133,
                                              0.05494709, 0.02579569, 0.2538931, -0.09713566])
