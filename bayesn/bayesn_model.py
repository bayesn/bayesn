...
class SEDmodel(object):
    ...
    def initial_guess(self, args, reference_model='M20_model'):
        ...
        if args['mode'] == 'training_v2':
            ...
            param_init['Wc_red'] = jnp.array([[0.07939839, 0.19760075, 1.8420886, 1.744319, -0.23905545,
                                               0.08004085, -0.60357636, -0.79211956, -0.2528549, -0.9032408,
                                               0.36387256, -1.0981401, 0.2042875, 1.6111058, 1.1309663,
                                               -0.00570234, -0.25722113, -1.270511, -0.617678, 0.3872624,
                                               0.09217103, 0.06121253, -0.08791034, -0.20553322, -0.36491907,
                                               -0.00921617, 0.41741753, -0.11745849, -0.05965865, -0.43961945,
                                               0.32216492, 0.6409845, 0.5914823, 0.01666246]])
