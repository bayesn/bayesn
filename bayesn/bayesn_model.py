...
class SEDmodel(object):
    ...
    def initial_guess(self, args, reference_model='M20_model'):
        ...
        if args['mode'] == 'training_v2':
            ...
            param_init['W0_red'] = jnp.array([-2.1369617e-01, -1.9828650e-01, -1.3920146e-01, -8.7053567e-02,
                                              9.3496703e-03, 1.4953532e+00, -3.1852588e-01, -3.4027331e-02,
                                              7.5822510e-02, 1.2340822e-01, 8.2892001e-01, 3.5941813e-02,
                                              1.5951350e-02, 5.7857599e-02, 7.6291054e-02, 8.0841750e-02,
                                              -7.4087158e-02, 3.4479715e-02, 7.7596366e-02, 1.7260702e-02,
                                              2.5365772e-02, 1.8662168e-01, 3.8550755e-01, -6.5437078e-01,
                                              1.5432292e-01, 6.5172493e-02, 1.8631917e-01, 2.3571628e-01,
                                              5.4301500e-01, -1.6843514e-01, -9.3141466e-04, -5.0955612e-02,
                                              5.6734804e-02, 1.5135711e-01, 2.2738409e-01])
            param_init['W1_red'] = jnp.array([-0.10696675, -2.2858584, -1.074576, -1.4087446, -0.8199879,
                                              0.01005398, -1.2466431, -0.6181944, -0.72626245, -0.1530763,
                                              -0.779818, -0.18534824, -0.841372, -0.7806929, -0.75058395,
                                              -0.47788963, 0.03881813, -0.32381842, -2.1669784, -0.6715823,
                                              0.21611553, -0.29917723, -1.303881, -1.2335104, -2.129433,
                                              -2.1236005, -1.7526256, -1.5852791, -1.2950703, -0.23351224,
                                              -0.9918693, -1.2538259, -1.335452, -2.3033154, -0.385861])
            param_init['Wc_red'] = jnp.array([0.09472057, 0.21951476, 1.8888448, 1.8285142, -0.17114444,
                                              0.08646076, -0.6344802, -0.7426186, -0.24922864, -0.898645,
                                              0.3845097, -1.0279708, 0.25431025, 1.6884495, 1.1547633,
                                              0.01439321, -0.2729062, -1.2838864, -0.5562208, 0.45301133,
                                              0.11323626, 0.06173746, -0.08333177, -0.1692569, -0.3542197,
                                              0.02494084, 0.4317892, -0.06638139, -0.07077129, -0.47508782,
                                              0.40199223, 0.65639466, 0.593285, 0.00458668])
